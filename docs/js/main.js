...
/* harmony import */ var _components_services_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/services.js */ "./src/js/components/services.js");
...
function setClasses(position, img) {
  let about = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  if (position == "show") {
...
swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper.use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Mousewheel, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation]);

// Main Slider
const paginationMenu = ['Компания', 'Решения', 'Продукция', 'Услуги', 'О нас', 'Экология', 'Новости'];
const mainSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.main-slider', {
  direction: 'vertical',
  speed: 500,
  pagination: {
...
const aboutSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.about__slider', {
  slidesPerView: 1,
  speed: 400,
  navigation: {
